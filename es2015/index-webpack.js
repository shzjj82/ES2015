...
/* harmony default export */ __webpack_exports__["a"] = (xxx);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__demo__ = __webpack_require__(0);

$('#btn').on('click', function() {
	var xx = $('.a input:checked:last').attr("_function");
	new __WEBPACK_IMPORTED_MODULE_0__demo__["a" /* default */]().getValue()
		.then((data) => {
			return new Promise((resolve) => {
